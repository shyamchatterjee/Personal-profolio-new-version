    ...
    return <> {mode=="dark"?<div className="contect-section" id="contect">
      ...
      <div className="contect-container">
        <div className="contect1">
          ...
          <div className="pera">
            <p>
              I am currently avliable to take on new projects, so feel free to
            </p>
          ...
          <div className="call">
            <img
              ...
              alt=""
            />{" "}
            <p style={{ color: "white", fontSize: "15px" }}>+919907843461</p>
          </div>
      ...
      <div className="footer">
        <div className="div">
          <div className="instagram">
            <img
              ...
              alt=""
            />
            <a href="https://maps.app.goo.gl/7koPcpZB9dAYfF2J9" target="_blank">
              
              <p style={{ fontSize: "15px", color: "white" }}>Kolkata,</p>
            </a>
          </div>
          <div style={{display:"flex",alignItems:"center"}}><p style={{color:"white",fontSize:"10px"}}>@</p>
        ...
        <div className="linkedin-github">
                 <div className="github-link">
                        <img src="https://static-00.iconduck.com/assets.00/github-icon-2048x2048-dpporae2.png" alt="" height={20} width={20}/>
                        <a href="https://github.com/shyamchatterjee"><p style={{fontSize:"15px", color:"white"}}>GitHub</p></a>
                 </div>
                  <div className="github-link">
                        <img src="https://static.vecteezy.com/system/resources/previews/018/930/480/large_2x/linkedin-logo-linkedin-icon-transparent-free-png.png" alt="" height={25} width={25}/>
                        <a href="https://www.linkedin.com/in/shyam-chatterjee-70bb7531a"><p style={{fontSize:"15px", color:"white"}}>Linkedin</p></a>
                 </div>
              
        </div>
      </div>
    </div>:<div className="contect-section" id="contect">
      <div className="contect-about">
        ...
        <div className="contect1">
          ...
          <div className="call">
            <img
              ...
              alt=""
            />{" "}
            <p style={{ color: "black", fontSize: "15px" }}>+919907843461</p>
          </div>
          <div className="facebook">
            <img
              src="https://th.bing.com/th/id/R.8b4e0813e813feab6c598f77887b1485?rik=G2l5mCAvaYfBmw&riu=http%3a%2f%2fwww.dayzcolony.com%2fwp-content%2fuploads%2f2017%2f10%2fFacebook-Circle-Icon.png&ehk=4QVaOzH7aUagUjzLAayVs1NUmFN%2bySZGWRnVZWo%2bDAU%3d&risl=&pid=ImgRaw&r=0"
      ...
      <div className="footer">
        <div className="div">
          ...
          <div style={{display:"flex",alignItems:"center"}}><p style={{color:"black",fontSize:"10px"}}>@</p>

          <p style={{color:"black"}}> 2025 Shyamdyuti Chatterjee.  All rights reserved.</p>
          </div>
        </div>
        <div className="linkedin-github">
                 <div className="github-link-light">
                        <img src="https://static-00.iconduck.com/assets.00/github-icon-2048x2048-dpporae2.png" alt="" height={20} width={20}/>
                        <a href="https://github.com/shyamchatterjee"><p style={{fontSize:"15px", color:"black"}}>GitHub</p></a>
                 </div>
                  <div className="github-link">
                        <img src="https://static.vecteezy.com/system/resources/previews/018/930/480/large_2x/linkedin-logo-linkedin-icon-transparent-free-png.png" alt="" height={25} width={25}/>
                        <a href="https://www.linkedin.com/in/shyam-chatterjee-70bb7531a"><p style={{fontSize:"15px", color:"black"}}>Linkedin</p></a>
                 </div>
