...
import './contect.css'
let Contect = ()=>{
     let { onSubmit, send, massage, msg, setmsg, email, setEmail, name, setName ,mode} =
    useContext(Context);
      return <div className="contect-section" id="contect">
      ...
      <div className="contect-container">
        ...
        <div className="contect2">
          <form className="form" onSubmit={onSubmit}>
            ...
            <p style={{ color: "green", fontSize: "22px" }}>{send}</p>
      ...
      <div className="footer">
        <div className="div">
          ...
          <div className="name-pera" style={{display:"flex",alignItems:"center"}}><p style={{color:"white",fontSize:"10px"}}>@</p>
